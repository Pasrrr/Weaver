 ...
 *
 */
public class PurchaseApplicationActionKJ extends BaseBean implements Action {
    private Log log = LogFactory.getLog(PurchaseApplicationActionKJ.class.getName());
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        try {
            ...
            for (Map<String, String> rowData : detailDatas) {
                ...
                /**物料编码*/
                contentXml.append("<MATNR>" + baseActionInfo.getDetailTableValue(rowData, "wlbmyc") + "</MATNR>");
                /**物料描述*/
                String TXZ01="";
                if (baseActionInfo.getDetailTableValue(rowData, "KNTTP").equals("K")||baseActionInfo.getDetailTableValue(rowData, "KNTTP").equals("F")){
                    TXZ01=baseActionInfo.getDetailTableValue(rowData, "chmctxt");
                }
                contentXml.append("<TXZ01>" + TXZ01 + "</TXZ01>");
                /**申请数量*/
