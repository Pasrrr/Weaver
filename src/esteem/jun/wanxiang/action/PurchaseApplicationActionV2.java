 ...
 *
 */
public class PurchaseApplicationActionV2 extends BaseBean implements Action {
    private Log log = LogFactory.getLog(PurchaseApplicationActionV2.class.getName());
