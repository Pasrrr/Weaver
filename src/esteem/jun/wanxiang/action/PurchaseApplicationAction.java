 ...
 *
 */
public class PurchaseApplicationAction extends BaseBean implements Action {
    private Log log = LogFactory.getLog(PurchaseApplicationAction.class.getName());
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        try {
            ...
            /**采购申请类型*/
            contentXml.append("<EQ_BSART>" + baseActionInfo.getMainTableValue("BSART") + "</EQ_BSART>");
            /**历史单据号*/
            ...
            for (Map<String, String> rowData : detailDatas) {
                ...
                /**采购申请中的价格*/
                contentXml.append("<PREIS>" + baseActionInfo.getDetailTableValue(rowData, "yjdj").replaceAll(",","") + "</PREIS>");
                /**价格单位*/
                ...
                /**申请理由*/
                contentXml.append("<ZREASON>" + baseActionInfo.getDetailTableValue(rowData, "sqly") + "</ZREASON>");
                /**使用产线*/
                contentXml.append("<ZSHYCHX>" + baseActionInfo.getDetailTableValue(rowData, "sycx") + "</ZSHYCHX>");
                /**具体使用设备*/
                contentXml.append("<ZSHYSHB>" + baseActionInfo.getDetailTableValue(rowData, "jtsysb") + "</ZSHYSHB>");
