 ...
 * @Description:索赔单
 */
public class PunishmentChangeReq {
    /**SRM流程ID*/
    ...
    private List<PunishmentChangeDetailReq> item1;

    private List<PunishmentChangeDetail2Req> item2;
    ...
    public List<PunishmentChangeDetailReq> getItem1() {
        return item1;
    }

    public void setItem1(List<PunishmentChangeDetailReq> item1) {
        this.item1 = item1;
    }

    public List<PunishmentChangeDetail2Req> getItem2() {
        return item2;
    }

    public void setItem2(List<PunishmentChangeDetail2Req> item2) {
        this.item2 = item2;
    }
}
