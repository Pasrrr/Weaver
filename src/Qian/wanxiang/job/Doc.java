...
import esteem.jun.sign.QianAPIUtil;
 ...
 * @Description:
 */
public class Doc extends BaseBean implements Action  {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        try {
            ...
            map.put("UserId", Prop.getPropValue("qian","Qian.UserID"));
            Form.put("Operator",map);
            JSONArray BusinessIds=new JSONArray();
            BusinessIds.add(baseActionInfo.getMainTableValue("flowid"));
...
/*        Date currentDate = new Date();
        ...
        docInfo.setOwnerid(1);//文档拥有者*/
            ...
            recordSet2.execute(fjinfo);
            String docsub="";
            if (recordSet2.next()){
                docsub=recordSet2.getString("DOCSUBJECT");
