...
public class YDQKD {
    ...
    private static Log log = LogFactory.getLog(YDQKD.class);
...
public Map execute(Map param) throws Exception {
        ...
        String querysql = "select * from formtable_main_434 where requestId=" + requestId;
        //用款审批数据
        ...
        while (rsquery.next()) {
            ...
            /**ERP端付款唯一标识*/
            String erpInsId = Util.null2String(rsquery.getString("dh"));
            /**付款单位*/
            ...
            String currencyNo = Util.null2String(rsquery.getString("bz"));
            switch (currencyNo){
                case "1":
                    currencyNo="CNY";
                    break;
            ...
            /**收款方账号*/
            String receAccountNo = Util.null2String(rsquery.getString("zh")).replaceAll(" ","");
            /**收款方户名*/
            String receAccountName = Util.null2String(rsquery.getString("dw"));
            /**收款方银行*/
            String receBankNo=Util.null2String(rsquery.getString("dhbh"));
            /**支行号*/
            String receCnaps=Util.null2String(rsquery.getString("swiftcode")).replaceAll(" ","");
            /**收款方开户行名称*/
            String receOpbankName = Util.null2String(rsquery.getString("khh"));
            /**对公\对私*/
            String persionFlag = "0";
            /**加急标识加急-1 不加急-0*/
            String urgentFlag = "0";
            /**付款摘要信息*/
            String purpose = Util.null2String(rsquery.getString("yt"));
            /**附言*/
            String remark = Util.null2String(rsquery.getString("bz2"));
            /**录入人*/
